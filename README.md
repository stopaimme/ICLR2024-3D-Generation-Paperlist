...
* Multi-view images as input, and add noise on different images with the same schedule                                                                            $\mathcal{I}=\left\{\mathbf{I}_1, \ldots, \mathbf{I}_N\right\}$, $\mathcal{I}_t=\left\{\sqrt{\bar{\alpha}_t} \mathbf{I}+\sqrt{1-\bar{\alpha}_t} \epsilon_{\mathbf{I}} \mid \mathbf{I} \in \mathcal{I}\right\}$
...
$\nabla_\theta \mathcal{L}_{\mathrm{BSD}}(\phi, g(\theta))=\mathbb{E}_{t, \boldsymbol{\epsilon}, c}\left[\omega(t)\left(\boldsymbol{\epsilon}_{\text {DreamBooth }}\left(\boldsymbol{x}_t ; y, t, r_{t^{\prime}}(\boldsymbol{x}), c\right)-\boldsymbol{\epsilon}_{\text {lora }}\left(\boldsymbol{x}_t ; y, t, \boldsymbol{x}, c\right)\right) \frac{\partial \boldsymbol{x}}{\partial \theta}\right]$
...
$\nabla_\theta \mathcal{L}_{\mathrm{VSD}}(\phi, g(\theta))=\mathbb{E}_{t, \boldsymbol{\epsilon}}\left[\omega(t)\left(\boldsymbol{\epsilon}_{\text {Pretrained}}\left(\boldsymbol{x}_t ; y, t\right)-\boldsymbol{\epsilon}_{\text {lora }}\left(\boldsymbol{x}_t ; y, t, x, c\right)\right) \frac{\partial \boldsymbol{x}}{\partial \theta}\right]$
...
#### Pipeline
In original SDS, the gradient is expressed as$\nabla_\theta \mathcal{L}_{\mathrm{SDS}}=\mathbb{E}_{t, \epsilon, \mathbf{c}}\left[w(t)\left(\epsilon_\phi\left(\mathbf{x}_t ; y, t\right)-\epsilon\right) \frac{\partial \mathbf{x}}{\partial \theta}\right]$
And can be expressed as
$\epsilon_\phi\left(\mathbf{x}_t ; y, t\right)-\epsilon =\delta_x\left(\mathbf{x}_t ; y, t\right) = \underbrace{\left[\epsilon_\phi\left(\mathbf{x}_t ; y, t\right)-\epsilon\right]}_{\delta_x^{\text {gen }}}+\omega \cdot \underbrace{\left[\epsilon_\phi\left(\mathbf{x}_t ; y, t\right)-\epsilon_\phi\left(\mathbf{x}_t ; t\right)\right]}_{\delta_x^{\text {cls }}}$
